...
class Registrasi_user extends Migration
{
    public function up()
    {
        $this->forge->addField([
        ...
        $this->forge->addKey('id_registrasiuser', TRUE);
        ...
        $this->forge->createTable('registrasi_user');
    }
    ...
    {
        $this->forge->dropTable('registrasi_user');
    }
}